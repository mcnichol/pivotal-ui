...
export class Dialog extends React.PureComponent {
  ...
  onKeyDown = e => {
    ...
    console.log(hideOnEscKeyDown, e.keyCode);
  ...
  render() {
    ...
    if (!disableAnimation) {
      backdropStyle.transition = `opacity ${animationDuration}ms ${animationEasing}`;
      dialogStyle.transition = `transform ${animationDuration}ms ${animationEasing}`;
    }
