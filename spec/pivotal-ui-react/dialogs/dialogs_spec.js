...
describe('Dialog', () => {
  ...
  it('renders a hidden backdrop', () => {
    ...
    expect('.pui-dialog-backdrop').toHaveAttr('style',
      'visibility: hidden; transition: opacity 200ms cubic-bezier(0.25, 0.46, 0.45, 0.94);'
    );
  ...
  it('renders a hidden dialog', () => {
    ...
    expect('.pui-dialog').toHaveAttr('style', 'transition: transform 200ms cubic-bezier(0.25, 0.46, 0.45, 0.94);');
  });
  ...
  describe('when the modal becomes visible', () => {
    ...
    it('renders a modal', () => {
      expect('.pui-dialog-backdrop').toHaveAttr('style', 'visibility: visible; transition: opacity 200ms cubic-bezier(0.25, 0.46, 0.45, 0.94);');
    ...
    describe('when show becomes false and animation is enabled', () => {
      beforeEach(() => {
        ...
        jasmine.clock().tick(Dialog.defaultProps.animationDuration); // TODO spies instead of ticks
      });
